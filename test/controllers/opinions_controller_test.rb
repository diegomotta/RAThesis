...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { ciudad: @opinion.ciudad, comentario: @opinion.comentario, nacionalidad: @opinion.nacionalidad, nombre: @opinion.nombre, provincia: @opinion.provincia }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { ciudad: @opinion.ciudad, comentario: @opinion.comentario, nacionalidad: @opinion.nacionalidad, nombre: @opinion.nombre, provincia: @opinion.provincia }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
