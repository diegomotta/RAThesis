...
resources :empresas do
  ...
  resources :productos do
    ...
    resources :item_productos do
       resources :galeria_imagenes
       resources :videos_productos
       resources :opinions
       resources :detalles do
          resources :prop_especificas
       end
    end
  end
  resources :informacion_empresas do
    resources :item_de_infos
  end
end
